...
Foreach-Object {$_ -replace 'ARCGIS_CATALOG_URL', $ArcGIS_Catalog}  | 
Foreach-Object {$_ -replace 'UDL_SERVICE_PREFIX', $UDL_Service_Prefix}  | 
Foreach-Object {$_ -replace 'SUE_SERVICE', $SUE_Publish_Service}  | 
Foreach-Object {$_ -replace 'SURVEY_SERVICE', $Survey_Publish_Service}  | 
Foreach-Object {$_ -replace 'FIELD_PREFIX', $Field_Prefix}  | 
Foreach-Object {$_ -replace 'SUE_WATER_POINTS_LAYER_ID', $SUE_WATER_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_WASTEWATER_POINTS_LAYER_ID', $SUE_WASTEWATER_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_TELECOM_POINTS_LAYER_ID', $SUE_TELECOM_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_PETROL_POINTS_LAYER_ID', $SUE_PETROL_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_GAS_POINTS_LAYER_ID', $SUE_GAS_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_ELECTRIC_POINTS_LAYER_ID', $SUE_ELECTRIC_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_WATER_LINES_LAYER_ID', $SUE_WATER_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_WASTEWATER_LINES_LAYER_ID', $SUE_WASTEWATER_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_TELECOM_LINES_LAYER_ID', $SUE_TELECOM_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_PETROL_LINES_LAYER_ID', $SUE_PETROL_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_GAS_LINES_LAYER_ID', $SUE_GAS_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_ELECTRIC_LINES_LAYER_ID', $SUE_ELECTRIC_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_PROJECTS_LAYER_ID', $SUE_PROJECTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_WATER_POINTS_LAYER_ID', $SURVEY_WATER_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_WASTEWATER_POINTS_LAYER_ID', $SURVEY_WASTEWATER_POINTS_LAYER_ID}  |
Foreach-Object {$_ -replace 'SURVEY_TELECOM_POINTS_LAYER_ID', $SURVEY_TELECOM_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_PETROL_POINTS_LAYER_ID', $SURVEY_PETROL_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_GAS_POINTS_LAYER_ID', $SURVEY_GAS_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_ELECTRIC_POINTS_LAYER_ID', $SURVEY_ELECTRIC_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_WATER_LINES_LAYER_ID', $SURVEY_WATER_LINES_LAYER_ID}  |
Foreach-Object {$_ -replace 'SURVEY_WASTEWATER_LINES_LAYER_ID', $SURVEY_WASTEWATER_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_TELECOM_LINES_LAYER_ID', $SURVEY_TELECOM_LINES_LAYER_ID}  |  
Foreach-Object {$_ -replace 'SURVEY_PETROL_LINES_LAYER_ID', $SURVEY_PETROL_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_GAS_LINES_LAYER_ID', $SURVEY_GAS_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_ELECTRIC_LINES_LAYER_ID', $SURVEY_ELECTRIC_LINES_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SURVEY_PROJECTS_LAYER_ID', $SURVEY_PROJECTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'APPROVAL_GPSERVICE_URL', $APPROVAL_GPSERVICE_URL}  | 
Out-File -encoding ASCII features.json

(Get-Content config.json.dist) | 
Foreach-Object {$_ -replace 'ARCGIS_CATALOG_URL', $ArcGIS_Catalog}  | 
Foreach-Object {$_ -replace 'UDL_SERVICE_PREFIX', $UDL_Service_Prefix}  | 
Foreach-Object {$_ -replace 'SUE_SERVICE', $SUE_Approval_Service}  | 
Foreach-Object {$_ -replace 'SURVEY_SERVICE', $Survey_Approval_Service}  | 
Foreach-Object {$_ -replace 'FIELD_PREFIX', $Field_Prefix}  | 
Foreach-Object {$_ -replace 'SUE_WATER_POINTS_LAYER_ID', $SUE_WATER_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_WASTEWATER_POINTS_LAYER_ID', $SUE_WASTEWATER_POINTS_LAYER_ID}  | 
Foreach-Object {$_ -replace 'SUE_TELECOM_POINTS_LAYER_ID', $SUE_TELECOM_POINTS_LAYER_ID}  | 
